...
def test_is_enabled():
    ...
    assert registry.is_enabled("controller.main_host") is True
    assert registry.is_enabled("controller.main_host_daily") is True
    assert registry.is_enabled("controller.main_hostmetric") is True
