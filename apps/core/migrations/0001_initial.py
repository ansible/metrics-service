    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-modified"],
                "indexes": [
                    models.Index(fields=["setting_key", "-modified"], name="core_settin_setting_69b439_idx"),
                    models.Index(fields=["last_modified_by", "-modified"], name="core_settin_last_mo_5b529e_idx"),
                ],
            },
        ),
    ]
