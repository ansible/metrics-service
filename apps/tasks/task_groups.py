...
SYSTEM_TASKS_GROUP = TaskGroup(
    ...
    tasks=[
        ...
        },
        {
            ...
            "cron": None,  # Run once after each system-task initialization
            "args": {
            ...
            "max_attempts": 5,
            "enabled": True,
            "description": "Reconcile users, orgs, teams and RBAC role assignments from Gateway during service initialization",
        },
    ],
)
