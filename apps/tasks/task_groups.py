...
METRICS_COLLECTION_GROUP = TaskGroup(
    ...
    tasks=[
        # Hourly Collection Tasks
        {
            ...
            "args": {"collector_type": "job_host_summary_service", "TASK_TIMEOUT_SECONDS": 240, "TASK_TYPE": "created"},
            "enabled": True,
        ...
        },
        {
            ...
            "args": {"collector_type": "unified_jobs", "TASK_TIMEOUT_SECONDS": 240, "TASK_TYPE": "created"},
            "enabled": True,
        ...
        },
        {
            ...
            "args": {"collector_type": "credentials_service", "TASK_TIMEOUT_SECONDS": 240, "TASK_TYPE": "created"},
            "enabled": True,
        ...
        },
        {
            ...
            "args": {"collector_type": "main_jobevent_service", "TASK_TIMEOUT_SECONDS": 240, "TASK_TYPE": "created"},
