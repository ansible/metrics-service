...
class CronTaskScheduler:
    ...
    def __init__(self):
        ...
        self.task_registry: dict[str, dict[str, Any]] = {
            # Example scheduled tasks - these can be modified at runtime
            "daily_cleanup": {
            ...
            # Add metrics-utility scheduled tasks
            "daily_billing_data": {
                "function": "gather_automation_controller_billing_data",
                "cron": "0 1 * * *",  # Daily at 1 AM
                "args": {},
                "enabled": True,
                "description": "Daily billing data collection",
            },
            "weekly_metrics_report": {
                "function": "build_metrics_report",
                "cron": "0 3 * * 0",  # Weekly on Sunday at 3 AM
                "args": {},
                "enabled": True,
                "description": "Weekly metrics report generation",
            },
        }
