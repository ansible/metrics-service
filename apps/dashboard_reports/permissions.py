...
VIEW_DASHBOARD = "view_automation_dashboard"
EDIT_DASHBOARD = "change_automation_dashboard"
...
def get_dashboard_scope(user) -> DashboardScope:
    """Resolve global admin/auditor access or organizations with dashboard view/edit permission."""
...
class DashboardReadPermission(BasePermission):
    """Allow platform dashboard readers and users with an organization dashboard role."""
