    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "collector",
                    models.CharField(help_text="Collector name (collector_type / API path segment)", max_length=128),
                ),
                (
                    "source",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="`since` passed to the collector (inclusive), if any", null=True
                    ),
                ),
                (
                    "until",
                    models.DateTimeField(
                        blank=True, help_text="`until` passed to the collector (exclusive), if any", null=True
                    ),
                ),
                ...
                (
                    "payload",
                    models.JSONField(default=dict, help_text="Raw pre-prepare() gather() output, JSON-serialisable"),
                ),
                (
                    "created_by",
                    models.ForeignKey(
