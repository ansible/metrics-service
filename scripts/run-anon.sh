...
uv run scripts/run_task.py collect_hourly_metrics '{"collector_type": "credentials_service"}'
uv run scripts/run_task.py collect_hourly_metrics '{"collector_type": "job_host_summary_service"}'
# disabled for now: uv run scripts/run_task.py collect_hourly_metrics '{"collector_type": "main_jobevent_service"}'
uv run scripts/run_task.py collect_hourly_metrics '{"collector_type": "unified_jobs"}'
